            ...
            .then(commitStats => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    parallelLimit(tasks, 20, function(err, results) {
                        ...
                        let authors = results.reduce(function(map, obj) {
                            map[obj.author] = obj.authorName;
                            return map;
                        }, {});

                        commitStats.forEach(cs => cs.authorName = authors[cs.author]);
